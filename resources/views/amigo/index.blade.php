                                    ...
                                    @foreach ($amigos as $amigo)
                                        <tr>
                                                ...
                                                <h6 class="fw-semibold mb-0 fs-4">
                                                    <a class="btn btn-info btn-circle">
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            ...
                                                            width="auto" height="auto" viewBox="0 0 24 24"
                                            ...
                                            <td class="border-bottom-0 text-center">
                                                <h6 class="fw-semibold mb-0 fs-4">
                                                    <button type="button"
                                                        class="btn btn-warning btn-circle" data-bs-toggle="modal"
        ...
        <form action="{{ url('/amigos/' . $amigo->id) }}" method="post">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalCenterTitle">Eliminar Amigo!.</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    <h5>Desea Eliminar A {{ $amigo->nombre }} {{ $amigo->apellidoPaterno }} {{ $amigo->apellidoMaterno }} De La Lista De Amigos?.</h5>
                </div>
